...
const COLORS = ["#4ECDC4","#FF6B6B","#45B7D1","#96CEB4","#FFEAA7","#DDA0DD","#98D8C8","#F7DC6F","#BB8FCE","#F1948A"];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
          <div style={{
            ...
            justifyContent: "center", fontSize: 28, fontWeight: 700, color: "#0a0a0f",
          }}>
        ...
        <input
          ...
          style={{
            ...
            color: "#fff", marginBottom: 8, outline: "none",
          }}
        />
        <div style={{ fontSize: 11, color: "#444", textAlign: "right", marginBottom: 16 }}>
          {name.length}/50
        </div>
